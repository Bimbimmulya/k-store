...
<div>
    ...
    <div class="cart">
        <div class="row">
            <div class="col-lg-3">
            <img class="img-cart" src="{{asset('img/'.$cart->krismon->image)}}" alt="">
            </div>
            <div class="col-lg-9">
                <div class="top">
                    <p class="item-name">{{$cart->krismon->product_name}}</p>
                    <div class="top-right">
                        <p class="">Rp.{{number_format($cart->krismon->price)}}</p>
                        ...
                        <!-- Subtotal -->
                        <p class="total-item">Rp.{{number_format($cart->krismon->price * $cart->qty)}}</p>
                    </div>
                </div>
                <hr class="mt-2 mb-2">
                <div class="bottom">
                   <div class="row">
                        ...
                        <div class="col-lg-2">
                        <!-- delete cart -->
                        <form action="/remove/{{$cart->id}}" method="POST">
                                @csrf
                                @method("DELETE")
...
@php
$total += ($cart->krismon->price * $cart->qty);
@endphp
@endforeach    
<div class="totalz">
